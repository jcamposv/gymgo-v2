  ...
  for (const template of templates) {
    ...
    for (const date of dates) {
      ...
      const classData: TablesInsert<'classes'> = {
        ...
        waitlist_enabled: templateData.waitlist_enabled,
        max_waitlist: templateData.max_waitlist,
        instructor_id: templateData.instructor_id,
        instructor_name: templateData.instructor_name,
        location: templateData.location,
        booking_opens_hours: templateData.booking_opens_hours,
        booking_closes_minutes: templateData.booking_closes_minutes,
        cancellation_deadline_hours: templateData.cancellation_deadline_hours,
      }
